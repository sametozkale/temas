...
/**
 * Temporary design-system smoke page. Replaced by the Home screen in the
 * AppShell phase. Verifies tokens, fonts, patched shadcn variants and the
 * custom components render as specified in docs/01-design-system.md.
 */
export default function DesignSystemPage() {
  return (
    <main className="mx-auto flex min-h-screen w-full max-w-[1080px] flex-col gap-8 px-6 py-10">
      <PageHeader
        title="Coming up"
        description="Tasarım sistemi doğrulama ekranı — Home fazında kaldırılacak."
        actions={
          <>
